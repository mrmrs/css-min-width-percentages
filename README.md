...
Functional CSS for min-width-percentages

## Filesize

| File | Size |
|------|------|
| `dist/min-width-percentages.css` | 15649 bytes |
| `dist/min-width-percentages.min.css` | 10235 bytes (1413 Gzipped) |

## Install

```sh
npm install css-min-width-percentages
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-min-width-percentages/dist/min-width-percentages.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-min-width-percentages/dist/min-width-percentages.min.css">
```
...
| `.mn-wi-1-s` | `min-width: 1%;` |
| `.mn-wi-2-s` | `min-width: 2%;` |
| `.mn-wi-3-s` | `min-width: 3%;` |
| `.mn-wi-4-s` | `min-width: 4%;` |
| `.mn-wi-5-s` | `min-width: 5%;` |
| `.mn-wi-6-s` | `min-width: 6%;` |
| `.mn-wi-7-s` | `min-width: 7%;` |
| `.mn-wi-8-s` | `min-width: 8%;` |
| `.mn-wi-9-s` | `min-width: 9%;` |
| `.mn-wi-10-s` | `min-width: 10%;` |
| `.mn-wi-11-s` | `min-width: 11%;` |
| `.mn-wi-12-s` | `min-width: 12%;` |
| `.mn-wi-13-s` | `min-width: 13%;` |
| `.mn-wi-14-s` | `min-width: 14%;` |
| `.mn-wi-15-s` | `min-width: 15%;` |
| `.mn-wi-16-s` | `min-width: 16%;` |
| `.mn-wi-17-s` | `min-width: 17%;` |
| `.mn-wi-18-s` | `min-width: 18%;` |
| `.mn-wi-19-s` | `min-width: 19%;` |
| `.mn-wi-20-s` | `min-width: 20%;` |
| `.mn-wi-21-s` | `min-width: 21%;` |
| `.mn-wi-22-s` | `min-width: 22%;` |
| `.mn-wi-23-s` | `min-width: 23%;` |
| `.mn-wi-24-s` | `min-width: 24%;` |
| `.mn-wi-25-s` | `min-width: 25%;` |
| `.mn-wi-26-s` | `min-width: 26%;` |
| `.mn-wi-27-s` | `min-width: 27%;` |
| `.mn-wi-28-s` | `min-width: 28%;` |
| `.mn-wi-29-s` | `min-width: 29%;` |
| `.mn-wi-30-s` | `min-width: 30%;` |
| `.mn-wi-31-s` | `min-width: 31%;` |
| `.mn-wi-32-s` | `min-width: 32%;` |
| `.mn-wi-33-s` | `min-width: 33%;` |
| `.mn-wi-34-s` | `min-width: 34%;` |
| `.mn-wi-35-s` | `min-width: 35%;` |
| `.mn-wi-36-s` | `min-width: 36%;` |
| `.mn-wi-37-s` | `min-width: 37%;` |
| `.mn-wi-38-s` | `min-width: 38%;` |
| `.mn-wi-39-s` | `min-width: 39%;` |
| `.mn-wi-40-s` | `min-width: 40%;` |
| `.mn-wi-41-s` | `min-width: 41%;` |
| `.mn-wi-42-s` | `min-width: 42%;` |
| `.mn-wi-43-s` | `min-width: 43%;` |
| `.mn-wi-44-s` | `min-width: 44%;` |
| `.mn-wi-45-s` | `min-width: 45%;` |
| `.mn-wi-46-s` | `min-width: 46%;` |
| `.mn-wi-47-s` | `min-width: 47%;` |
| `.mn-wi-48-s` | `min-width: 48%;` |
| `.mn-wi-49-s` | `min-width: 49%;` |
| `.mn-wi-50-s` | `min-width: 50%;` |
| `.mn-wi-51-s` | `min-width: 51%;` |
| `.mn-wi-52-s` | `min-width: 52%;` |
| `.mn-wi-53-s` | `min-width: 53%;` |
| `.mn-wi-54-s` | `min-width: 54%;` |
| `.mn-wi-55-s` | `min-width: 55%;` |
| `.mn-wi-56-s` | `min-width: 56%;` |
| `.mn-wi-57-s` | `min-width: 57%;` |
| `.mn-wi-58-s` | `min-width: 58%;` |
| `.mn-wi-59-s` | `min-width: 59%;` |
| `.mn-wi-60-s` | `min-width: 60%;` |
| `.mn-wi-61-s` | `min-width: 61%;` |
| `.mn-wi-62-s` | `min-width: 62%;` |
| `.mn-wi-63-s` | `min-width: 63%;` |
| `.mn-wi-64-s` | `min-width: 64%;` |
| `.mn-wi-65-s` | `min-width: 65%;` |
| `.mn-wi-66-s` | `min-width: 66%;` |
| `.mn-wi-67-s` | `min-width: 67%;` |
| `.mn-wi-68-s` | `min-width: 68%;` |
| `.mn-wi-69-s` | `min-width: 69%;` |
| `.mn-wi-70-s` | `min-width: 70%;` |
| `.mn-wi-71-s` | `min-width: 71%;` |
| `.mn-wi-72-s` | `min-width: 72%;` |
| `.mn-wi-73-s` | `min-width: 73%;` |
| `.mn-wi-74-s` | `min-width: 74%;` |
| `.mn-wi-75-s` | `min-width: 75%;` |
| `.mn-wi-76-s` | `min-width: 76%;` |
| `.mn-wi-77-s` | `min-width: 77%;` |
| `.mn-wi-78-s` | `min-width: 78%;` |
| `.mn-wi-79-s` | `min-width: 79%;` |
| `.mn-wi-80-s` | `min-width: 80%;` |
| `.mn-wi-81-s` | `min-width: 81%;` |
| `.mn-wi-82-s` | `min-width: 82%;` |
| `.mn-wi-83-s` | `min-width: 83%;` |
| `.mn-wi-84-s` | `min-width: 84%;` |
| `.mn-wi-85-s` | `min-width: 85%;` |
| `.mn-wi-86-s` | `min-width: 86%;` |
| `.mn-wi-87-s` | `min-width: 87%;` |
| `.mn-wi-88-s` | `min-width: 88%;` |
| `.mn-wi-89-s` | `min-width: 89%;` |
| `.mn-wi-90-s` | `min-width: 90%;` |
| `.mn-wi-91-s` | `min-width: 91%;` |
| `.mn-wi-92-s` | `min-width: 92%;` |
| `.mn-wi-93-s` | `min-width: 93%;` |
| `.mn-wi-94-s` | `min-width: 94%;` |
| `.mn-wi-95-s` | `min-width: 95%;` |
| `.mn-wi-96-s` | `min-width: 96%;` |
| `.mn-wi-97-s` | `min-width: 97%;` |
| `.mn-wi-98-s` | `min-width: 98%;` |
| `.mn-wi-99-s` | `min-width: 99%;` |
| `.mn-wi-100-s` | `min-width: 100%;` |
...
Example: `.mn-wi-1-m` applies the property at the medium breakpoint and above.
...
Processes `src/min-width-percentages.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/min-width-percentages.css` — formatted
- `dist/min-width-percentages.min.css` — minified
